...
func (ur *urlRepository) Create(c context.Context, url *entity.Url) error {
...
func (ur *urlRepository) UpdateByExpiryTime(c context.Context, shortCode string, expiryTime time.Time, userID uint) error {
	var url entity.Url
...
func (ur *urlRepository) DeleteByShortCode(c context.Context, shortCode string, userID uint) error {
	var url entity.Url
...
func (ur *urlRepository) FetchAllByUserID(c context.Context, userID uint, page int, size int) ([]entity.Url, error) {
	var urls []entity.Url

...
func newUrl(db *gorm.DB, opts ...gen.DOOption) url {
	...
	_url.ID = field.NewUint(tableName, "id")
	...
	_url.ExpiryTime = field.NewTime(tableName, "expiry_time")
	_url.UserID = field.NewUint(tableName, "user_id")
...
func (u *url) updateTableName(table string) *url {
	...
	u.ExpiryTime = field.NewTime(table, "expiry_time")
